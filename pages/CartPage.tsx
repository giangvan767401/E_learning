...
import { Trash2, ArrowRight, ShoppingBag, ShieldCheck, Zap, ArrowLeft } from 'lucide-react';
  ...
  if (items.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        <div className="bg-white p-12 rounded-3xl border border-dashed border-slate-200 inline-block">
          ...
          <Link to="/courses" className="px-8 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition-all">
            Explore Courses
          </Link>
        </div>
      </div>
    ...
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="grid lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-6">
          {items.map((item) => (
            <div key={item.id} className="bg-white p-6 rounded-2xl border border-slate-200 flex flex-col sm:flex-row gap-6 hover:border-blue-300 transition-all">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 text-xs font-bold uppercase tracking-wider text-slate-400">
                  <span className="flex items-center gap-1 text-blue-600"><Zap className="w-3 h-3" /> Lifetime Access</span>
              ...
              <div className="text-right sm:min-w-[100px]">
                ...
                <div className="text-xs text-slate-400 line-through">$89.99</div>
              </div>
            </div>
          ))}
        ...
        <div className="space-y-6">
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-xl shadow-slate-100 sticky top-24">
            ...
            <button className="w-full py-4 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-100 flex items-center justify-center gap-2 mb-4">
          ...
          <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
            ...
            <div className="flex gap-2">
              <input type="text" placeholder="CODE123" className="flex-1 bg-white border border-slate-200 rounded-lg px-3 text-sm" />
              <button className="px-4 py-2 bg-slate-900 text-white rounded-lg text-sm font-bold">Apply</button>
            </div>
          </div>
        </div>
      </div>
