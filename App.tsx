      ...
      <div className="min-h-screen flex flex-col bg-slate-50/50">
        ...
        <main className="flex-grow">
          <Routes>
            ...
            {/* Fix: Wrap component instances as children for ProtectedRoute */}
            <Route path="/learn/:id" element={<ProtectedRoute><CourseLearning /></ProtectedRoute>} />
            <Route path="/dashboard" element={<ProtectedRoute><StudentDashboard /></ProtectedRoute>} />
            <Route path="/admin" element={<ProtectedRoute><AdminDashboard /></ProtectedRoute>} />
            <Route path="/admin/course/new" element={<ProtectedRoute><CourseEditor /></ProtectedRoute>} />
            <Route path="/admin/course/edit/:id" element={<ProtectedRoute><CourseEditor /></ProtectedRoute>} />
            <Route path="/admin/predict" element={<ProtectedRoute><PredictionPage /></ProtectedRoute>} />
